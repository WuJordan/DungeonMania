...
public class Game {
    ...
    public void battle(Player player, Enemy enemy) {
        ...
        if (enemy.getBattleStatistics().getHealth() <= 0) {
            ...
            player.setNumEnemiesKilled(player.getNumEnemiesKilled() + 1);
        }
    }
    ...
    public BattleStatistics applyMercBuffs(BattleStatistics playerBuff) {
    ...
    public void spawnZombie(Game game, ZombieToastSpawner zts) {
        entityFactory.spawnZombie(game, zts);
    }
    ...
    public int getNumZombies() {
        return map.getEntities(ZombieToast.class).size();
    }
}
